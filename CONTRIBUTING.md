# Contributing to grid-collection-view-controller
...
* **Did the problem start happening recently** (e.g. after updating to a new version of grid-collection-view-controller) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of grid-collection-view-controller ?** What's the most recent version in which the problem doesn't happen? You can download older versions of grid-collection-view-controller from [the releases page](https://github.com/digipolitan/grid-collection-view-controller/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of grid-collection-view-controller are you using?
...
#### Template For Submitting Bug Reports
    ...
    **grid-collection-view-controller version:** [Enter grid-collection-view-controller version here]
    ...
    * Problem started happening recently, didn't happen in an older version of grid-collection-view-controller: [Yes/No]
